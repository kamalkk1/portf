...
const navBar = {
  ...
  const mainBody = {
    ...
    icons: [
      {
        image: "fa-github",
        url: "https://github.com/kamalkk1",
      },
      {
        image: "fa-facebook",
        url: "https://www.facebook.com/kamal.kashyap.566",
      },
      {
        image: "fa-instagram",
        url: "https://www.instagram.com/k_kay8055?igshid=OGQ5ZDc2ODk2ZA==",
      },
      {
        image: "fa-linkedin",
        url: "https://www.linkedin.com/in/kamal-kishore-104882244/",
      },
    ],
  };
  ...
  const about = {
    show: true,
    heading: "About Me",
    imageLink: require("../editable-stuff/kamalpic.png"),
    imageSize: 375,
    message:
      "My name is Kamal Kishore. I’m a post-graduate of 2018 from Panjab University at Chandigarh with a degree in Bachelors In Commerce. I'm most passionate about giving back to the community, and my goal is to pursue this passion within the field of software engineering. In my free time I like working on open source projects.",
    resume:
      "https://drive.google.com/file/d/1RvTNu82VzKvMX9mJK_2blxXlD1Kde1kj/view?usp=sharing",
  };
  ...
  const repos = {
    ...
    gitHubUsername: "kamalkk", //i.e."johnDoe12Gh"
    reposLength: 4,
    specificRepos: [],
  };
    ...
    data: [
      {
        ...
        companylogo: require("../editable-stuff/vendify.png"),
        date: "May 2022 – Present",
      },
      {
        role: "React Developer",
        companylogo: require("../editable-stuff/simpana.png"),
